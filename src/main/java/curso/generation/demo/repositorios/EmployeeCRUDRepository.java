...
public interface EmployeeCRUDRepository extends CrudRepository<Employee, Integer> {
	...
	@Query("from Employee as E where E.nombre=:nombre and E.apellidos=:apellidos andd E.dni=:dni and E.identificador=:identificador and E.fecha_alta=:fecha_alta")
	public Employee getEmployeeAlta(String nombre, String apellidos, String dni, String identificador, String fecha_alta);

	@Query("from Employee as E where E.nombre=:nombre and E.apellidos=:apellidos andd E.dni=:dni and E.identificador=:identificador and E.fecha_alta=:fecha_alta and E.fecha_baja=:fecha_baja")
